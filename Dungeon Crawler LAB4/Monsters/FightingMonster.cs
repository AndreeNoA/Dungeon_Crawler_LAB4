...
namespace DungeonCrawlerVersion61.Monsters
{
    internal class FightingMonsters : MonsterBase, IFightMonster
    {
        ...
        {
            Console.WriteLine("Du får möte en " + Name);
            Console.WriteLine($"Den har {Damage} i skada och {Health} i liv.");
            Console.WriteLine($"Du har {player.playerAttackDamage} i skada");
            Console.ReadKey();
